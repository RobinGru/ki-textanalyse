<script lang="ts">
  ...
  import { countFindingsByCategory, displayComparisonValue, findingColors as colors, findingLabels as labels, forensicKindLabel as forensicKind, payloadCodepoints, payloadHex } from './checker-presentation';
  ...
  $: categories = report ? countFindingsByCategory(report.findings) : [];
